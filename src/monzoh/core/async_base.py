"""Async base API client for Monzo API."""
...
class AsyncMockResponse:
    """Async mock HTTP response for testing purposes.
    ...
    def raise_for_status(self) -> None:
        ...
        Raises:
            create_error_from_response: If status code indicates an error (>= 400)
        """
...
class BaseAsyncClient:
    """Asynchronous base HTTP client for Monzo API operations.
    ...
    async def whoami(self) -> WhoAmI:
        ...
        """
        response = await self._get("/ping/whoami")
