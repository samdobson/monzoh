...
**Note:** As of version 1.2.0, Monzoh automatically retries rate limit errors with exponential backoff. See the [Retry Handling](/guides/retry-handling) guide for configuration options.
...
**Note:** As of version 1.2.0, Monzoh automatically retries server errors with exponential backoff. See the [Retry Handling](/guides/retry-handling) guide for configuration options.
