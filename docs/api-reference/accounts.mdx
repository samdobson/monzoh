...
# Get balance using OO-style method (preferred)
balance = account.get_balance()

# Alternative: client-style method
...
for i, account in enumerate(accounts, 1):
    ...
    # Get balance for this account using OO-style method (preferred)
    balance = account.get_balance()
...
# Mock balance data using OO-style method (preferred)
