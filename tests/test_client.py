...
class TestMonzoClient:
    ...
    def test_init(self, mock_sync_http_client: Any) -> None:
        ...
        assert client._base_client._http_client is mock_sync_http_client
    ...
    def test_whoami(
        ...
        result = monzo_sync_client.whoami()

        assert result.authenticated is True
        assert result.client_id == "test_client_id"
        assert result.user_id == "test_user_id"

    def test_create_oauth_client(self, mock_sync_http_client: Any) -> None:
...
class TestOAuthClient:
    ...
    def test_exchange_code_for_token(
        ...
        token = oauth_sync_client.exchange_code_for_token("test_code")
    ...
    def test_exchange_code_error(
        ...
        with pytest.raises(MonzoBadRequestError):
            oauth_sync_client.exchange_code_for_token("invalid_code")
    ...
    def test_refresh_token(
        ...
        token = oauth_sync_client.refresh_token("old_refresh_token")
    ...
    def test_logout(
        ...
        oauth_sync_client.logout("test_token")
