...
class TestAccountsAPI:
    ...
    def test_list_accounts(
        ...
        mock_response = mock_httpx_response(json_data={"accounts": [sample_account]})
        monzo_sync_client._base_client._get.return_value = mock_response

        accounts = monzo_sync_client.accounts.list()
    ...
    def test_list_accounts_with_filter(
        ...
        accounts = monzo_sync_client.accounts.list(account_type="uk_retail")
    ...
    def test_get_balance(
        ...
        mock_response = mock_httpx_response(json_data=sample_balance)
        monzo_sync_client._base_client._get.return_value = mock_response

        balance = monzo_sync_client.accounts.get_balance("acc_123")
