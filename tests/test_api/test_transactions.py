...
class TestTransactionsAPI:
    ...
    def test_annotate_transaction(
        ...
        cast("Mock", monzo_client._base_client._patch).return_value = mock_response
        ...
        cast("Mock", monzo_client._base_client._patch).assert_called_once()
        call_args = cast("Mock", monzo_client._base_client._patch).call_args
        assert "/transactions/tx_123" in call_args[0][0]
